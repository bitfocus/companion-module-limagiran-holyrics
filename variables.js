module.exports = async function (self) {
	self.setVariableDefinitions([
		...
		{ variableId: 'current_text', name: 'Holyrics: Text currently displayed (lyrics/verse/text)' },
		...
		{ variableId: 'mp_mute', name: 'MediaPlayer: muted' },
		{ variableId: 'mp_repeat', name: 'MultiPlayer: Auto-Repeat' },
		{ variableId: 'mp_execute_single', name: 'MultiPlayer: Repeat single' },
		{ variableId: 'mp_fullscreen', name: 'MultiPlayer: Fullscreen' },
